"""
    A representation of IDA-plugin arguments.
"""
...
class IDAPluginArguments(ToolArguments):
    """A representation of IDA-plugin arguments."""

    def __init__(self, *, idb_file=None, output_file=None, **kwargs):
        """
        :param File idb_file: Input IDA database file.
        :param File output_file: Output file.

        All arguments are passed to :class:`.ToolArguments`.
        """
        super().__init__(**kwargs)
        self.idb_file = idb_file
    ...
    def as_list(self):
        ...
        # IDA database file.
        if self.idb_file is not None:
            arg_list.extend(['--idb', self.idb_file.path])
    ...
    def without_paths_and_output_files(self):
        ...
        args._remove_path_from_file_attr('idb_file')
    ...
    def with_rebased_files(self, inputs_dir, outputs_dir):
        ...
        args._rebase_file_attr('idb_file', inputs_dir)
    ...
    def from_test_settings(cls, test_settings):
        ...
        # IDA database file.
        cls._verify_attr_is_not_list(test_settings, 'idb')
        args._set_file_attr_if_not_none(test_settings, 'idb')
